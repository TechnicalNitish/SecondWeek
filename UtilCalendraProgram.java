...
public class UtilCalendraProgram {
	
	
	 //Function to match the given month and return its maximum days
   public static int findMaxDay(String mname, int y)
    {
  ...
  public static void fillCalendar(int max, int f, String mname, int y)
    {
        int A[][] = new int[6][7];
        int x = 1, z = f;
   ...
   public static void printCalendar(int A[][], String mname, int y)
    {  
        System.out.println("\n\t----------------------------------------------------");
